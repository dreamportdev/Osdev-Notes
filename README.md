...
The [latest-master](https://codeberg.org/dreamportdev/Osdev-Notes/releases/tag/latest-master) release contains the PDF built from master.

You can reach us on 
* Discord: [https://discord.gg/NGasazGkqr](https://discord.gg/NGasazGkqr)
* FLuxer: [https://fluxer.gg/8L9eRwcy](https://fluxer.gg/8L9eRwcy)
...
* [DreamOs](https://github.com/dreamos82/Dreamos): 32-bit OS written from scratch. This project is discontinued, but it still worth mentioning. Also by [Ivan G](https://codeberg.org/dreamos82).
