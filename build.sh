...
pandoc_flags="--toc --top-level-division=chapter -f markdown+raw_tex -t pdf --pdf-engine=pdflatex -N --lua-filter .pandoc/makerelative.lua"
pandoc_command="pandoc ${pandoc_flags}"
exclusion_pattern="/README.md"
